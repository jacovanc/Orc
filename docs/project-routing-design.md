...
- The generated setup prompt is a zero-Orc-prerequisite bootstrap. Normal built-in Amp plugin management publishes a public, versioned, digest-pinned worker into the authenticated user's Personal Plugins before project pairing. Reloading alone is never presented as installation.
